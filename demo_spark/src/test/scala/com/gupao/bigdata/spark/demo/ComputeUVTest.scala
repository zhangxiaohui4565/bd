...
class ComputeUVTest extends FunSuite with BeforeAndAfter {
  ...
  test("pv compute") {
    ...
    val seq = Seq(
      ...
      "183.193.62.196\thttp://gp-bd-master01.com/page2.html\tuid=7A1313ACD1D3F15A9103FD7A02040304\t26/May/2018:21:05:27 +0800"
    )
    ...
    print(keyValueMap)
    assert(keyValueMap("/page1.html") == 1)
    assert(keyValueMap("/page2.html") == 2)
  }
