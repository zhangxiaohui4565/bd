package com.gupao.bd.kafka_streams.demo.order_analysis.model;
...
public class OrderUserItem {
    ...
    public static OrderUserItem fromOrderUser(Object orderUser, Item item) {
        OrderUserItem orderUserItem = fromOrderUser((OrderUser) orderUser);
        if (item == null) {
            return orderUserItem;
        }
